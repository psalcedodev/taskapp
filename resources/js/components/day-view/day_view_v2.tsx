                ...
                case 'in_progress':
                  return isPastDue ? (
                    ...
                    <div className="flex flex-col items-end">
                      <button
                        type="button"
                        className="relative inline-flex items-center gap-1 rounded-md bg-[#2ecc71] px-3 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-[#27ae60] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#2ecc71] disabled:cursor-not-allowed disabled:opacity-50"
