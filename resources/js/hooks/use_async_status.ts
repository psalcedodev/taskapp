...
export function useAsyncStatus(broadcast: ActionBroadcast<any> | Broadcast<Status, any>) {
  const status = useAsyncValue('status' in broadcast ? broadcast.status : broadcast);
